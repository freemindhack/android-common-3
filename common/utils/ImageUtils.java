...
public class ImageUtils {
	...
	public static Drawable scaleDrawable (final Drawable d,
		int toPxW, int toPxH) {
		...
		Bitmap newbmp =
			Bitmap.createBitmap(oldbmp, 0, 0, width,
				height, matrix, true); // 建立新的 bitmap ，其内容是对原 bitmap 的缩放后的图
		return new BitmapDrawable(newbmp); // 把 bitmap 转换成 drawable 并返回
	}


	public static Bitmap
		drawableToBitmap (final Drawable d) {
