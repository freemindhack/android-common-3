...
public final class OverscrollHelper {
	 ...
	 * 
	 * @param view - Pull2RefreshView that is calling this.
	...
	public static void overScrollBy (
		final Pull2RefreshBase<?> view, final int deltaX,
		final int scrollX, final int deltaY,
		final int scrollY, final boolean isTouchEvent) {
		overScrollBy(view, deltaX, scrollX, deltaY,
			scrollY, 0, isTouchEvent);
	}
	...
	public static void overScrollBy (
		...
		final int scrollX, final int deltaY,
		final int scrollY, final int scrollRange,
		final int fuzzyThreshold, final float scaleFactor,
		final boolean isTouchEvent) {

		final int deltaValue, currentScrollValue, scrollValue;
		switch (view.getPull2RefreshScrollDirection()) {
		case HORIZONTAL:
			deltaValue = deltaX;
			scrollValue = scrollX;
		...
		if (view.isPull2RefreshOverScrollEnabled()
			...
			if (mode.permitsPull2Refresh() && !isTouchEvent
				...
				&& State.OVERSCROLLING == view.getState()) {
	...
	public static boolean isAndroidOverScrollEnabled (
		View view) {
