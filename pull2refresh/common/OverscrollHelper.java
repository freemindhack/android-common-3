...
public final class OverscrollHelper {
	 ...
	 * 
	 * @param view
	 *            - Pull2RefreshView that is calling this.
	 * @param deltaX
	 ...
	 */
	public static void overScrollBy (final Pull2RefreshBase <?> view,
	 ...
	 *            - Threshold for which the values how fuzzy we should treat
	 *            the other values. Needed for WebView as it doesn't always
	...
	public static void overScrollBy (final Pull2RefreshBase <?> view,
		...
		// refreshing.
		if (view.isPull2RefreshOverScrollEnabled() && !view.isRefreshing()) {
