...
/**
 * A sample implementation of how to use {@link Pull2RefreshExpandableListView}
...
public class PullToRefreshExpandableListFragment
	...
	protected Pull2RefreshExpandableListView
		onCreatePullToRefreshListView (
			LayoutInflater inflater,
			Bundle savedInstanceState) {
		return new Pull2RefreshExpandableListView(
			getActivity());
	}
