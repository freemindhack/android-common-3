...
public class Pull2RefreshListView extends
	...
	protected void onReset () {
		...
		if (listViewLoadingLayout.getVisibility() == View.VISIBLE) {
			 ...
			 */
			if (scrollLvToEdge
				&& getState() != State.MANUAL_REFRESHING) {
				mRefreshableView.setSelection(selection);
	...
	protected LoadingLayoutProxy
		...
		LoadingLayoutProxy proxy =
			super.createLoadingLayoutProxy(includeStart,
				includeEnd);
	...
	protected void handleStyledAttributes (TypedArray a) {
		...
		mListViewExtrasEnabled =
			a.getBoolean(
				R.styleable.Pull2Refresh_ptrListViewExtrasEnabled,
				true);
		...
		if (mListViewExtrasEnabled) {
			...
			mHeaderLoadingView =
				createLoadingLayout(getContext(),
					Mode.PULL_FROM_START, a);
			mHeaderLoadingView.setVisibility(View.GONE);
			frame.addView(mHeaderLoadingView, lp);
			mRefreshableView.addHeaderView(frame, null,
				false);
	...
	@TargetApi (9)
	final class InternalListViewSDK9 extends
		InternalListView {
		...
		protected boolean overScrollBy (int deltaX,
			...
			OverscrollHelper.overScrollBy(
				Pull2RefreshListView.this, deltaX, scrollX,
	...
	protected class InternalListView extends ListView
		...
		public void setAdapter (ListAdapter adapter) {
			...
			if (null != mLvFooterLoadingFrame
				&& !mAddedLvFooter) {
				addFooterView(mLvFooterLoadingFrame, null,
					false);
				mAddedLvFooter = true;
			}
